...
```
npm create cloudflare@latest -- --template=cloudflare/templates/withered-truth-187a
```

A live public deployment of this template is available at [https://withered-truth-187a.templates.workers.dev](https://withered-truth-187a.templates.workers.dev)
